...
function getIconPath(type) {
    ...
    if (typeStr.includes("粉") || typeStr.includes("羽")) return "picture/mushroom_pink.png";
    ...
    if (reportForm) {
        reportForm.addEventListener("submit", async (e) => {
            ...
            const mushroomData = {
                ...
                lat: latVal || existingLat || null,
                lng: lngVal || existingLng || null,
                reporterIP: userIP,
                status: "active"
            };
        ...
        keys.forEach(id => {
            ...
            if (msLeft > 0) {
                ...
                if (cooldownMsLeft <= 60000 && alertEnabledList.includes(id) && !notifiedMushrooms.includes(`${id}_born_1m`)) {
                    notifiedMushrooms.push(`${id}_born_1m`);
