...
function calculatePower() {
    ...
    if (selectedMushroom !== 'none') {
        if (selectedMushroom === 'event_special') {
            // 本月特殊活動蘑菇邏輯：任何顏色都可參戰，提供 +300 的獨立增幅
            match = 300;
...
function setupReportForm() {
    mushroomForm.addEventListener('submit', (e) => {
        ...
        const size = document.getElementById('form-size').value; // 讀取大小
        ...
        const pCount = document.getElementById('form-count').value; 
        ...
        const typeMapping = {
            ...
            event: { title: "本月限定活動蘑菇", img: "mushroom_event.png" } // 新增活動圖片對應
        };
        ...
        newCard.innerHTML = `
            ...
            <p>👥 目前人數：<span class="p-count">${pCount}</span> 人</p>
        `;
